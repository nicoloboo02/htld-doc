...
'''
- Retrospectiva (= que la semana anterior)
	- Rendimiento del equipo (Matriz de rendimiento de esfuerzo -> eje X esfuerzo y eje Y rendimiento )
	- Mejora del agendamiento (Reunión con doodle fakeada de la Semana 9)
	- Justificar la replanificación del Sprint 2 **(No pongo nada pq esta retrospectica es del sprint 3)**
	- Análisis de la calidad del software (Evolución por sprints)
	- Problemas -> Problema, solución, objetivo y métrica para analizar la calidad de la solución. **(No tenemos ningun problema registrado en el sprint 3)**
	- Reloj del proyecto
	- Plan de pruebas (Pruebas de carga de back, tipos de tests realizados) -> Riesgos surgidos en base a eso con el respectivo análisis, etc **(Aún no está completo este documento)**
	- Presumir de lo bueno (Añadir aquí aportaciones de valor que hayamos hecho de forma adicional)
- G. Pilot user 
	- Estado actual, feedback y cambios realizados en base a eso, además de mencionar que es lo que se ha decidido no hacer. (Priorizar el feedback y mostrar un ranking)
	- Calendario de usuarios piloto del sprint 3.
	- CA de usuarios piloto
- Planificación del Sprint 3
	- Con issues de github projects
	- Tareas del Sprint 3
	- Objetivos del Sprint 3 (Objetivos de la demo del sprint 3 -> API de correo o correo de confirmación y pasarela de pago incluidos)
	- Planificación del PPL (Marketing 3.0)
- Uso de la IA
	- Incluir de la carboon footprint 
	- Mejora del uso de las IAs hasta ahora
	- Que nos ha aportado positivamente/negativamente
