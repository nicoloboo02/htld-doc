...
- Y - Pues porque en mi familia, casi no llegamos a final de mes. Con la subida del precio de los alimentos hemos tenido que pedir ayuda y en la asociación que estuvimos para darnos de alta, nos pegamos toda la mañana allí y al final no pudieron hacerlo porque se les quedó colgado el Excel. Encima/Luego (como queráis decirlo) se pusieron a hacerlo manualmente pero nos pedían muchísimos papeles que no teníamos a mano y nos quedamos sin registrarnos.
