...
Tras 2 semanas de Sprint 2, hemos considerado una serie de cambios con respecto a la planificación del Sprint 2, también consideramos los requisitos que se veían reflejando en la **[Planificación Inicial](/docs/Planificación/Planificación%20Inicial)**.
