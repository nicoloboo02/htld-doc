...
### 2.5 Costes de adquisición total
...
#### 3.1.4 Conclusión
Teniendo en cuenta lo expuesto anteriormente, hemos visto viables tres opciones para el despliegue de la infraestructura de la aplicación teniendo en cuenta la calidad del sistema:
...
La tercera opción que barajamos es la mejor en cuanto a rendimiento y funcionamiento, pero también la de mayor precio. En esta opción se utilizaría el servicio de Google Cloud para el despliegue de la aplicación, con el servicio de App Engine para el backend, Vercel para el frontend y Mongo Atlas dedicated para la base de datos. Este coste serían 65,60€ + 0€ + 57,00€ = 122,60€ mensuales.
...
Finalmente, como buscamos el mejor rendimiento del sistema sin llegar a un coste excesivo, creemos que la mejor opción es la tercera. 
Es decir que nos decantamos por el servicio de App Engine para el backend, Vercel para el frontend y Mongo Atlas dedicated para la base de datos.
...
Para el alcance de este proyecto suponemos
...
El coste total de la propiedad anual es de **91.2K**.

## 5. Estado actual del TCO
