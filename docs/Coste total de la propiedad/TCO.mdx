...
| 9.0     | 2024-03-14 | Actualización del documento |
...
- En el eje Y se representa el Capex dedicado a cada una de las semanas, donde el coste ideal es el Capex total entre las 15 semanas, por eso es un valor constante
