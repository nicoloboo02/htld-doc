...
## 2. Costes de desarrollo del proyecto (Capex)
...
### 2.3 Costes de desarrollo total
...
El coste total de desarrollo del proyecto, teniendo en cuenta los costes de personal y de material:
...
Esta opción de despliegue se basa en una estimación de la carga y tráfico de las organizaciones, Tertulia Cofrade Cirio y Costal y Asociación Ciudadana de Ayuda al Toxicómano, donde su requerimientos no superan los límites gratuitos de Vercel y PlanetScale.
...
En nuestro caso, teniendo en cuenta que tenemos una carga de usuarios mínima porque solamente utilizan el sistema los administradores de las ONG 'S, suponemos suficiente la contratación de 2 desarrolladores para el mantenimiento del sistema una vez esté en completo funcionamiento. 
...
### 3.2 Costes de licencias
En este proyecto, para la CI/CD, se utiliza GitHub Actions, pues además se utiliza GitHub para el desarrollo de este. Hay que tener en cuenta que los repositorios de este proyecto son abiertos (open source), por lo que podemos contar con el plan gratuito que se ofrece en GitHub, sin tener que añadir así estos costes. En la siguiente imagen podemos ver qué nos ofrecen si nuestro repositorio es público. Suponemos que todo esto es suficiente para el correcto funcionamiento del sistema final.

| GitHub Plan|
| ------ |
|<img src="/img/tco/github-precios.png" alt="GitHub Plan" width="100%" height="100%"/>

Aún así, en caso de que GitHub Actions dejase de ofrecer un plan gratuito para proyectos open source, utilizamos la calculadora de GitHub para obtener el precio de este. Para ello, suponemos un número de workflows de 2 diarios (60 mensuales) y una duración aproximada de 5 minutos cada uno de ellos, lo que nos lleva a un precio final de 2.22€ mensuales.
| GitHub Actions|
| ------ |
|<img src="/img/tco/github-actions.png" alt="GitHub Actions" width="100%" height="100%"/>

Como en la actualidad para los proyectos open source, como el nuestro, este plan es gratuito, en nuestro TCO actual los costes de la licencia de GitHub siguen siendo de 0€. 

Además, el resto de herramientas que pueden necesitar los desarrolladores para la operación son de uso gratuito, como pueden ser los entornos de desarrollo integrados gratuitos como VSCode o sistemas de comunicación gratuitos como Discord.
...
Teniendo en cuenta todos los costes previos, se obtiene un coste total de 51058.27€. Por lo que el coste de contingencia sería: 0,15 x 51058.27 = 7658.75€.
...
| ------- | ---------- | ------------------------ | ------------------------ |
| CapEx  | Desarrollo | -  | 34554.67€ (34.6K) |
| OpEx   | Despliegue | 25.30€ | 303.60€ (0.4K) |
| OpEx   | Personal | 450.00€  | 5400.00€ (5.5K) |
| OpEx   | Licencias | 0.00€ | 0.00€ (0K) |
| OpEx   | GDPR | 900.00€ | 10800.00€ (10.9K)|
| OpEx   | Contingencia | -  | 7658.75€ (7.7K) |
| Total  | TCO | -  | **58717.02€ (60K)** |


El coste total de la propiedad anual es de 60K.
