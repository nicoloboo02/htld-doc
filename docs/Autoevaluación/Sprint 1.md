...
| T-10) Cumplimiento de Instrucciones | Seguir las instrucciones establecidas en las pautas del revisor de software y evitar cualquier condición de suspensión relacionada con ellas                                                  | [] Sí [x] No |  4  | [Ver en detalle](#justificación-de-la-software-reviewer-guidelines)  |
